...
const ControlSchema = `
CREATE TABLE IF NOT EXISTS mail_resources_v2 (
 tenant_id TEXT NOT NULL, kind TEXT NOT NULL, resource_id TEXT NOT NULL,
 generation INTEGER NOT NULL, state TEXT NOT NULL, resource_json BLOB NOT NULL,
 updated_at TIMESTAMP NOT NULL, PRIMARY KEY (tenant_id,kind,resource_id)
);
CREATE TABLE IF NOT EXISTS mail_operations_v2 (
 command_id TEXT PRIMARY KEY, command_digest TEXT NOT NULL, idempotency_key TEXT NOT NULL,
 tenant_id TEXT NOT NULL, kind TEXT NOT NULL, resource_id TEXT NOT NULL,
 status TEXT NOT NULL, receipt_json BLOB NOT NULL, accepted_at TIMESTAMP NOT NULL,
 completed_at TIMESTAMP NULL, UNIQUE (tenant_id,idempotency_key)
);
CREATE TABLE IF NOT EXISTS mail_dkim_rotations_v2 (
 tenant_id TEXT NOT NULL, domain_id TEXT NOT NULL, domain_generation INTEGER NOT NULL,
 state TEXT NOT NULL, rotation_json BLOB NOT NULL, updated_at TIMESTAMP NOT NULL,
