...
func safeStateComponent(value string) bool {
	switch value {
	case "instances", "databases", "principals", "grants", "policies", "sessions", "tuning", "upgrades", "effects", "compensations", "migration-restores", "transfer-imports", "transfer-fences":
		return true
	default:
		return false
	}
