...
type Outcome string
const OutcomePrepared Outcome = "prepared"
...
func validOutcome(v Outcome)bool{switch v{case OutcomePrepared,OutcomeAllowed,OutcomeDenied,OutcomeApplied,OutcomeRejected,OutcomeAmbiguous,OutcomeFailed:return true};return false}
