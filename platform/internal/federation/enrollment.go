...
type EnrollmentResponse struct{PeerID ID;PeerSigningKeys map[string]SigningKeyTrust;NodeCertificate []byte;NodeCertificateRef string;CertificateExpiresAt time.Time;AuthorityEpoch uint64}
