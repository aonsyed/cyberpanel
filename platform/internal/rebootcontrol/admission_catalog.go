...
var admissionSources=[]admissionSource{
	...
	{"package_maintenance_hold_operations",[]string{"id"},"state","'succeeded','failed'",""},
	{"package_maintenance_repairs",[]string{"id"},"state","'planned','succeeded','failed'",""},
	{"malware_scan_jobs_v1",[]string{"id"},"state","'completed','failed','cancelled'",""},
	{"malware_quarantines_v1",[]string{"id"},"state","'active','released','deleted'",""},
	{"malware_remediations_v1",[]string{"id"},"state","'proposed','approved','succeeded','compensated'",""},
