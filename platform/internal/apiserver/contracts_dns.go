...
type DNSAuthorityService interface{
	ApplyZone(context.Context,string,dns.ZoneSpec,[]dns.RecordSet,[]dns.TransferPeerSpec)(dns.AuthorityReceipt,error)
	DeleteZone(context.Context,string,dns.ZoneSpec)(dns.AuthorityReceipt,error)
	...
	ListRecordSets(context.Context,dns.ZoneSpec,int,string)([]dns.RecordSet,string,error)
}
