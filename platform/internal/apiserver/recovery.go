...
type RecoveryController struct{Identity *identity.Service;Claims ClaimTokenStore;Core CoreTransport;TrustPaths TrustPaths;Clock func()time.Time;StaticHA *ha.StaticDeploymentService;PeerVotes *ha.PeerVoteService}
