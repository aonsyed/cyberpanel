...
func registerWebEngineContracts(registry *Registry)error{
	operations:=[]Operation{
		...
		{Name:"webengine.tuning.apply",Permission:identity.MustPermission("webengine:manage"),Assurance:identity.AssuranceMFA,Auth:AuthRequired,Mutating:true,NewPayload:func()any{return &WebEngineTunePayload{}},ResolveScope:installationScope},
	}
