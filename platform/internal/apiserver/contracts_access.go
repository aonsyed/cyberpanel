...
func registerAccessContracts(registry *Registry)error{
	...
	return registerHostFilesystemContracts(registry)
}

func bindAccess(registry *Registry,services DomainServices)error{
	if services.Files==nil{return bindHostFilesystemContracts(registry,services)}
