...
type rebootControlLocalRuntime struct{db *sql.DB;admissions *rebootcontrol.AdmissionGate;windows *maintenance.Repository;evaluator *maintenance.Evaluator;packages *packagemaint.SQLRepository;reboots *rebootcontrol.Repository;executor operations.HostExecutor;ha ha.SQLRepository;now func()time.Time}
