...
func run()error{
	...
	epoch,err:=readKeyEpoch(secretEpochPath,ownerUID);if err!=nil{return err};key,err:=secrets.NewFileKEK(secretKeyPath,epoch,ownerUID);if err!=nil{return err};broker,err:=secrets.NewBroker(store,key,secrets.LinuxConsumerRegistry{});if err!=nil{return err}
	materialPolicy,err:=secrets.NewLinuxMaterialPeerAuthorizer(0,uint32(controlUID));if err!=nil{return err}
	managementPolicy,err:=secrets.NewLinuxMaterialPeerAuthorizer(0,uint32(controlUID));if err!=nil{return err}
