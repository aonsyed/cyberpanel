...
export interface FieldDefinition {
  key: string;
  label: string;
  type: "text" | "password" | "number" | "boolean" | "select" | "textarea" | "hostname" | "cidr" | "cron";
  required?: boolean;
...
export const pages: Record<string, PageDefinition> = {
  ...
  wordpress: {
    id:"wordpress",title:"WordPress & applications",description:"Certified app installs, inventory, updates, caching, autologin, staging, and security.",resourceKind:"apps.instance",listOperation:"apps.instance.list",
    createAction:{id:"install",label:"Install app",operation:"apps.instance.install",mutating:true,assurance:"mfa",fields:[{key:"site_id",label:"Site",type:"text",required:true},{key:"application",label:"Application",type:"select",required:true,defaultValue:"wordpress",options:[{label:"WordPress",value:"wordpress"}]},{key:"version",label:"Version",type:"text",required:true},{key:"recipe_id",label:"Signed catalog recipe",type:"text",required:true},{key:"administrator_username",label:"Administrator username",type:"text",required:true},{key:"administrator_email",label:"Administrator email",type:"text",required:true},{key:"administrator_display_name",label:"Administrator display name",type:"text",required:true},{key:"administrator_password",label:"Administrator password",type:"password",required:true,helper:"Used once during bootstrap, stored only in the protected secret broker, then revoked."},{key:"locale",label:"Locale",type:"text",required:true,defaultValue:"en_US"},{key:"timezone",label:"Timezone",type:"text",required:true,defaultValue:"UTC"},{key:"title",label:"Site title",type:"text"}]},
    ...
    rowActions:[{id:"login",label:"Secure login",operation:"apps.wordpress.autologin.issue",mutating:true,tone:"info"},{id:"update",label:"Update",operation:"apps.instance.update",mutating:true,fields:[{key:"recipe_id",label:"Signed target recipe",type:"text",required:true},{key:"version",label:"Expected target version",type:"text"}]},{id:"cache",label:"Purge cache",operation:"apps.wordpress.cache.purge",mutating:true,fields:[{key:"scope",label:"Purge scope",type:"select",required:true,defaultValue:"all",options:[{label:"Everything",value:"all"},{label:"Paths",value:"path"},{label:"Cache tags",value:"tag"}]},{key:"values",label:"Paths or tags",type:"textarea",helper:"Enter one value per line. Leave empty when purging everything."}]},{id:"scan",label:"Scan",operation:"apps.scan.start",mutating:true,fields:[{key:"mode",label:"Scan depth",type:"select",required:true,defaultValue:"quick",options:[{label:"Quick",value:"quick"},{label:"Full",value:"full"},{label:"Integrity comparison",value:"integrity_comparison"}]}]},{id:"remove",label:"Remove",operation:"apps.instance.remove",mutating:true,tone:"critical",assurance:"mfa",confirmation:"A verified recovery point is created before the application files and managed database are purged."}],emptyTitle:"No managed applications",emptyBody:"Install or adopt an application on an existing site."
  },
  databases: {
  ...
  marketing: {
    ...
    createAction:{id:"campaign",label:"Create campaign",operation:"marketing.campaign.create",mutating:true,fields:[{key:"list_id",label:"Audience list",type:"text",required:true},{key:"subject",label:"Subject",type:"text",required:true},{key:"template_ref",label:"Approved template",type:"text",required:true},{key:"schedule",label:"Schedule",type:"cron"}]},
    ...
    rowActions:[{id:"inspect",label:"Delivery attempts",operation:"marketing.attempt.list",mutating:false},{id:"start",label:"Start",operation:"marketing.campaign.start",mutating:true,assurance:"mfa"},{id:"pause",label:"Pause",operation:"marketing.campaign.pause",mutating:true,tone:"warning"},{id:"cancel",label:"Cancel",operation:"marketing.campaign.cancel",mutating:true,tone:"critical"}],globalActions:[{id:"audiences",label:"Lists & consent",operation:"marketing.list.list",mutating:false},{id:"suppressions",label:"Suppressions",operation:"marketing.suppression.list",mutating:false}],emptyTitle:"No campaigns",emptyBody:"Create a campaign only after importing or collecting evidenced consent."
  },
  containers: {
...
export const navigation: NavigationGroup[] = [
  ...
  {id:"hosting",label:"Hosting",items:[
    ...
    {id:"wordpress",label:"Applications",route:"/applications",icon:"Package",pageId:"wordpress",keywords:["wordpress","joomla","magento","staging"]}
  ]},
