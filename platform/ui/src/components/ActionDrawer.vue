      ...
      <form @submit.prevent="submit">
        <div class="drawer-body">
          <div v-for="field in action.fields||[]" :key="field.key" class="field">
            ...
            <input v-else :id="`field-${field.key}`" v-model="values[field.key]" class="input" :class="{mono:field.type==='cidr'||field.type==='cron'}" :type="field.type==='password'?'password':field.type==='number'?'number':'text'" :required="field.required"/>
